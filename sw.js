    ...
    caches.match(event.request).then((cachedResponse) => {
      ...
      return fetch(event.request).then((networkResponse) => {
        ...
        if (event.request.mode === 'navigate') {
          return new Response(
            '<html><body style="background:#0f0f11;color:#fff;font-family:sans-serif;text-align:center;padding-top:40vh;"><h1>Day Counter</h1><p>Sei offline. Controlla la connessione.</p></body></html>',
